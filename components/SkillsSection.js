...
const SkillsSection = () => {
  ...
  // Split the skills array into three rows: 7, 6, 5
  const row1 = skills.slice(0, 7); // First 7 icons
  const row2 = skills.slice(7, 13); // Next 6 icons
  const row3 = skills.slice(13, 18); // Last 5 icons
  ...
  return (
    <section id="skills" className="bg-black text-white py-6">
      <div className="mx-auto px-6 md:px-8 lg:px-16">
        ...
        <SectionHeader title={'skills'} description={'Expert in Full Stack Development and Software Development.'} linkText={''} link={''} />
        ...
        <div className="space-y-4 mt-6 md:mt-24 px-0 md:px-8 lg:px-16 opacity-90">
          ...
          {/* Row 3: 5 icons */}
          <div className="flex justify-between mb-0 md:mb-20 px-6 md:px-16 lg:px-32">
